...
site_dict = {
    'well pad': {
        'number': 104, # The number of basic_site instances to simulate in the gas_field
        'parameters': well_pad
    }
    ,
# If additional site types are needed, they should be added here as separate dict entries
    'compressor station': {
        'number': 5, # The number of basic_site instances to simulate in the gas_field
...
def make_iteration(ind):
    ...
    scenario.run(dir_out='TutorialResults-MC-MyField', display_status=False, save_method='pickle')